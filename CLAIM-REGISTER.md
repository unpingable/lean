...
| Field | Value |
|-------|-------|
| **Location** | Stable root `LeanProofs/JudgmentOrientation.lean`; theorem modules `JudgmentOrientation/{Core,Attribution,Provenance,OriginSupport,Bridge}.lean`; fixtures in the separately imported `Examples.lean` ANNEX. Release inventory: [`docs/V12-RELEASE-LEDGER.md`](docs/V12-RELEASE-LEDGER.md). |
