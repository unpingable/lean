/-
  Wired.Divergence — the divergence-ball coordinate (resource-sensitive).
  ...
  is impossible for a positive step — the witness ages. See `Wired.CarryLaws` for
  the cost identity.
-/
import Wired.CarryLaws

namespace Wired.Divergence
