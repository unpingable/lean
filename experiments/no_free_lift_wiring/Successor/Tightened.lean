/-
  Successor.Tightened — the model-admission discipline for the witnessed-derivation
  ...
  axis `Discriminating`. The obstruction (`DisciplineObstruction`) proved
...
namespace Successor.Tightened

open Wired Wired.NoFreeLift
...
/-- **tightened_metatheory** — under a sound floor and the discipline, the judgment is
