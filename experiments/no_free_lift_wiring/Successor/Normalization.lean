/-
  Successor.Normalization — the canonical-form theorem that earns the calculus claim:
  ...
  `Tightened` (it imports only the spine, never the discipline).
-/

import Wired.Embedding

namespace Successor.Normalization
