/-
  Admissibility.PathVerdict.EvidencePromotionCoverage -- specimen theorem
  coverage for obstruction-coded evidence promotion.

  Custody-Class: PUBLIC-SHIPPED
  Surface-Role: PUBLIC-EVIDENCE
  This terminal evidence introduces no parser, IO, sockets, daemon, concrete
  DSL syntax, or runtime gate.
...
import LeanProofs.Admissibility.PathVerdict.StandardObstructions
