/-
  LeanProofs.CustodyIndexed.Evidence.DeltaTSequent -- F1 of the post-v4 cluster: Δt as a
  derivation step.
  ...
  Post-v4 work (docs/POST-V4-CAMPAIGN.md), now retained as terminal public
  evidence rather than part of the exact stable root.
  ...
  Correspondence (cited, not wired): stable substrate
  `BoundedCalculi.TemporalCustody` is the bounded face of the same wall
...
namespace LeanProofs.CustodyIndexed.Evidence.DeltaTSequent

open LeanProofs.CustodyIndexed.CustodyIndexedSequent (System IsEvidence
  EvidenceNeverConcluded)
open LeanProofs.CustodyIndexed.StructuralPolicySequent (ContextPolicy cartesian)
open LeanProofs.CustodyIndexed.EvidenceCalculusSequent (EvidenceCalculus EChain
...
end LeanProofs.CustodyIndexed.Evidence.DeltaTSequent
