/-
  LeanProofs.CustodyIndexed.OccurrenceTrace -- v5 slice 4: the positional occurrence
  trace. WHO PAID.
...
import LeanProofs.CustodyIndexed.LinearNormalization

namespace LeanProofs.CustodyIndexed.OccurrenceTrace
...
open LeanProofs.CustodyIndexed.StructuralPolicySequent (PJ PIx DupRule dupSystem)
open LeanProofs.CustodyIndexed.StructuralNormalization (Core)
open LeanProofs.CustodyIndexed.LinearNormalization (split_nil_left wsum_append
...
def _root_.LeanProofs.CustodyIndexed.StructuralNormalization.Core.linearizeT
...
end LeanProofs.CustodyIndexed.OccurrenceTrace
