/-
  LeanProofs.CustodyIndexed.TracedCoherence -- v6 slice 1: traced/untraced
...
import LeanProofs.CustodyIndexed.OccurrenceTrace

namespace LeanProofs.CustodyIndexed.TracedCoherence
...
open LeanProofs.CustodyIndexed.StructuralPolicySequent (linear)
...
open LeanProofs.CustodyIndexed.LinearNormalization (LinResult removeFirstC
  split_nil_left)
open LeanProofs.CustodyIndexed.OccurrenceTrace (TLinResult removeFirstT)
...
theorem trace_refines_untraced_run [DecidableEq J]
  ...
  subst hΔ
  exact ⟨⟨d', hd⟩,
    LeanProofs.CustodyIndexed.OccurrenceTrace.trace_labels_are_reads d h⟩
...
theorem untraced_runs_trace_canonically [DecidableEq J]
  ...
  · intro l
    ...
    exact h.symm
  · intro tr Δt h i
    exact LeanProofs.CustodyIndexed.OccurrenceTrace.linearize_trace_occurrences_distinct
      d tagged_unambiguous h i

end LeanProofs.CustodyIndexed.TracedCoherence
