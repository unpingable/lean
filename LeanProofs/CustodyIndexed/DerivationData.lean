/-
  LeanProofs.CustodyIndexed.DerivationData -- the v5 seed (F7 artifact): derivations
...
namespace LeanProofs.CustodyIndexed.DerivationData

open LeanProofs.CustodyIndexed.CustodyIndexedSequent (System IsEvidence
  EvidenceNeverConcluded)
open LeanProofs.CustodyIndexed.StructuralPolicySequent (ContextPolicy)
...
end LeanProofs.CustodyIndexed.DerivationData
