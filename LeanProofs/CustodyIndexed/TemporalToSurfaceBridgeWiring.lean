/-
  LeanProofs.CustodyIndexed.TemporalToSurfaceBridgeWiring -- real-shape wiring probe
  for the Temporal -> Surface bridge.

  Custody-Class: PUBLIC-SHIPPED
  Surface-Role: STABLE-SURFACE
  This stable wiring is reached through the exact
  `LeanProofs.CustodyIndexed` stable root.

  This imports the real bounded-calculi vocabularies and the stable adapter
...
namespace LeanProofs.CustodyIndexed.TemporalToSurfaceBridgeWiring
...
structure TemporalSurfaceBridgeEvidence
  ...
  mappedTemporalDemands : LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.EstablishesMappedDemands env action use
...
theorem dropped_projection_drops_mapped_freshness :
    ¬ LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.RetainsGate
        LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.droppedFreshnessProjection LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.TemporalGate.freshAtUse := by
  intro h
  rcases h with ⟨atom, hrep, hretained⟩
  unfold LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.SurfaceRepresents LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.TemporalGate.surfaceAtom at hrep
  cases hrep
  exact LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.dropped_freshness_projection_retains_no_freshness hretained
...
theorem temporally_valid_does_not_authorize_when_mapped_freshness_dropped :
    ∃ (env : TemporalCustody.Env)
      ...
      LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.DemandsGate SurfaceProjection.Use.projectedUse LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.TemporalGate.freshAtUse ∧
      ¬ LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.RetainsGate projection LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.TemporalGate.freshAtUse ∧
      ¬ SurfaceProjection.ProjectionAuthorized
          surface projection SurfaceProjection.Use.projectedUse := by
  refine ⟨TemporalCustody.permissiveEnv,
    TemporalCustody.fullyCheckedAction,
    LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.projectedSurface,
    LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.droppedFreshnessProjection,
    ?_, ?_, ?_, ?_⟩
  · exact TemporalCustody.fully_checked_action_temporally_valid
  · exact LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.projected_use_demands_mapped_freshness
  · exact dropped_projection_drops_mapped_freshness
  · exact LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.temporal_validity_does_not_authorize_dropped_mapped_freshness.2
...
/-! ## Reverse cut + bidirectional independence (Run C strengthening, 2026-07-01)
    ...
    vocabulary (which would extend the public evidence model and open new-atom design), we make
...
theorem temporal_surface_mutual_nonimplication :
  ...
  ⟨⟨TemporalCustody.permissiveEnv, TemporalCustody.fullyCheckedAction,
     LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.projectedSurface,
     LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.droppedFreshnessProjection,
     LeanProofs.CustodyIndexed.TemporalSurfaceAdapter.temporal_validity_does_not_authorize_dropped_mapped_freshness⟩,
   ⟨projectedSurface, retainedProjectedUseProjection,
     TemporalCustody.permissiveEnv, TemporalCustody.staleAtExecutionAction,
     concrete_positive_bridge_authorizes_projected_use,
     TemporalCustody.staleAtExecution_not_temporally_valid⟩⟩

end LeanProofs.CustodyIndexed.TemporalToSurfaceBridgeWiring
