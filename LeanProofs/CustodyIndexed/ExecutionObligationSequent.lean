/-
  LeanProofs.CustodyIndexed.ExecutionObligationSequent -- Sequent 3: obligation/residue
...
import LeanProofs.CustodyIndexed.ExecutionSequent
import LeanProofs.BoundedCalculi.ObligationResidue

namespace LeanProofs.CustodyIndexed.ExecutionObligationSequent

open LeanProofs.Witnessed.ResourceSequent (Split Consumes
  mem_residual_of_mem_input_not_consumed mem_input_of_mem_consumed)
open LeanProofs.CustodyIndexed.ExecutionSequent (Ticket ticketA)
...
end LeanProofs.CustodyIndexed.ExecutionObligationSequent
