/-
  LeanProofs.CustodyIndexed.EvidenceCalculusSequent -- derived evidence + the
...
import LeanProofs.CustodyIndexed.StructuralPolicySequent

namespace LeanProofs.CustodyIndexed.EvidenceCalculusSequent

open LeanProofs.CustodyIndexed.CustodyIndexedSequent (System IsEvidence
  EvidenceNeverConcluded)
open LeanProofs.CustodyIndexed.StructuralPolicySequent (ContextPolicy cartesian linear)
...
theorem diamond_no_universal_stamp :
    ∀ e : LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ,
      ¬ UniversalStamp LeanProofs.CustodyIndexed.CustodyIndexedSequent.diamondSystem e := by
  intro e h
  have h1 := h LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.a
    LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.b
    ⟨LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.eAB,
      LeanProofs.CustodyIndexed.CustodyIndexedSequent.DRule.ab⟩
  cases h1 with
  | ab =>
      have h2 := h LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.b
        LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.d
        ⟨LeanProofs.CustodyIndexed.CustodyIndexedSequent.DJ.eBD,
          LeanProofs.CustodyIndexed.CustodyIndexedSequent.DRule.bd⟩
      cases h2

end StampDetection

end LeanProofs.CustodyIndexed.EvidenceCalculusSequent
