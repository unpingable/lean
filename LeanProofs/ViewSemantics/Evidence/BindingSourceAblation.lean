/-
  Binding-Source Ablation — terminal public specimen.

  Custody-Class: PUBLIC-SHIPPED
  Surface-Role: PUBLIC-EVIDENCE

  Adjudicated as terminal public evidence in v13 after two same-day blind
  review rounds on 2026-07-10: the first corrected the compliance-source
  framing; the second renamed the rung-two property — a fatal consequence is
  not a binding. It is the unchanged source dependency of the public
  `ViewSemantics.Applications` adapter and remains outside the exact stable
  `LeanProofs.ViewSemantics` root.
