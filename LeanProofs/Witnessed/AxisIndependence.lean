/-
  ...
  Mathlib-free stable surface, isolated by `lake build Witnessed`. Schematic
  over a 3-element model; axiom-free.
...
namespace LeanProofs.Witnessed.AxisIndependence

open LeanProofs.Witnessed.NoFreeLift LeanProofs.Witnessed.Discipline
...
end LeanProofs.Witnessed.AxisIndependence
