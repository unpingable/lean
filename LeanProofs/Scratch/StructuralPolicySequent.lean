/-
  LeanProofs.Scratch.StructuralPolicySequent -- structural-policy
...
import LeanProofs.Scratch.CustodyIndexedSequent
import LeanProofs.BoundedCalculi.MeasureAccounting

namespace LeanProofs.Scratch.StructuralPolicySequent
...
theorem s4_recovered_under_cartesian
    {Γ : List LeanProofs.Scratch.BridgeCompositionSequent.Judgment}
    {j : LeanProofs.Scratch.BridgeCompositionSequent.Judgment} :
    LeanProofs.Scratch.BridgeCompositionSequent.Entail Γ j ↔
      PEntail LeanProofs.Scratch.CustodyIndexedSequent.s4System
        (cartesian _) Γ j Γ := by
  constructor
  · intro h
    exact pentail_cartesian_iff.mpr
      ⟨LeanProofs.Scratch.CustodyIndexedSequent.s4_entail_iff.mp h, rfl⟩
  · intro h
    exact LeanProofs.Scratch.CustodyIndexedSequent.s4_entail_iff.mpr
      (pentail_cartesian_iff.mp h).1

theorem diamond_recovered_under_cartesian :
    PEntail LeanProofs.Scratch.CustodyIndexedSequent.diamondSystem
      (cartesian _)
      [LeanProofs.Scratch.CustodyIndexedSequent.DJ.a,
  ...
  pentail_cartesian_iff.mpr
    ⟨LeanProofs.Scratch.CustodyIndexedSequent.diamond_route_B, rfl⟩

end LeanProofs.Scratch.StructuralPolicySequent
