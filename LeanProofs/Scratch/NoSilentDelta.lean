/-
  LeanProofs.Scratch.NoSilentDelta -- post-v7 extraction-pass pilot: the
...
open LeanProofs.Scratch.OccurrenceTrace (trace_labels_are_reads
  linearizeT_ok_conserves)
open LeanProofs.Scratch.TracedCoherence (tagged untraced_runs_trace_canonically)
...
end LeanProofs.Scratch.NoSilentDelta
