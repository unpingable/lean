/-
  LeanProofs.Scratch.BridgeSequent -- Sequent 0 + Sequent 1 of the sequent ladder.
...
namespace LeanProofs.Scratch.BridgeSequent
...
theorem entail_sound
  ...
  | bridgeCut _hT _hB ihT ihB =>
      intro hGamma
      exact
        LeanProofs.Scratch.TemporalToSurfaceBridgeWiring.positive_bridge_authorizes_when_retained_or_converted
          { temporal := ihT hGamma
...
def concreteContext : List Judgment :=
  [Judgment.tValid TemporalCustody.permissiveEnv TemporalCustody.fullyCheckedAction,
   Judgment.bEvid TemporalCustody.permissiveEnv TemporalCustody.fullyCheckedAction
     LeanProofs.Scratch.TemporalToSurfaceBridgeWiring.projectedSurface
     LeanProofs.Scratch.TemporalToSurfaceBridgeWiring.retainedProjectedUseProjection
...
theorem concreteContext_sem : ContextSem concreteContext := by
  ...
  | tail _ hj =>
      ...
      | head =>
          exact ⟨rfl,
            LeanProofs.Scratch.TemporalToSurfaceBridgeWiring.projected_use_demands_supplied_by_real_rules⟩
      | tail _ hj => cases hj
...
end LeanProofs.Scratch.BridgeSequent
