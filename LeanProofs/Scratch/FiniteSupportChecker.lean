/-
  LeanProofs.Scratch.FiniteSupportChecker -- v6 slice 2: the finite-support
...
def _root_.LeanProofs.Scratch.StructuralNormalization.Core.check
...
def _root_.LeanProofs.Scratch.StructuralNormalization.Core.checkCtx
    [DecidableEq J] {S : System J Ix} {E : EvidenceCalculus S}
...
theorem checkCtx_trace_entries_from_context [DecidableEq J]
  ...
  | ok tr' Δt =>
      ...
      subst h
      intro p hp
      have hmem := LeanProofs.Scratch.OccurrenceTrace.trace_mem_initial
        d ht hp
      refine ⟨hmem, ?_⟩
...
theorem paid_tree_checks_ok :
  ...
  simp [Core.checkCtx, Core.check, tagged,
    LeanProofs.Scratch.TracedCoherence.tagFrom,
    LeanProofs.Scratch.OccurrenceTrace.same_label_distinct_occurrences_traced]
...
theorem free_contraction_checks_refused :
  ...
  simp [Core.checkCtx, Core.check, tagged,
    LeanProofs.Scratch.TracedCoherence.tagFrom,
    LeanProofs.Scratch.OccurrenceTrace.free_contraction_still_forges_tagged]
...
end LeanProofs.Scratch.FiniteSupportChecker
