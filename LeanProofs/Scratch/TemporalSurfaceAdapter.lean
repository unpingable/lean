/-
  LeanProofs.Scratch.TemporalSurfaceAdapter -- real-module vocabulary adapter
  for the Temporal -> Surface bridge probe.

  Custody-Class: SCRATCH. Un-wired, compile-is-contact only. This module imports
  the real bounded-calculi ANNEX modules to test whether the scratch
  `TemporalToSurfaceBridge` vocabulary can be expressed without laundering
  meaning. It is NOT imported by `LeanProofs.lean` or `LeanProofs.BoundedCalculi`.
...
namespace LeanProofs.Scratch.TemporalSurfaceAdapter
...
/-! ## Real-shape bridge evidence, still scratch-local -/
...
end LeanProofs.Scratch.TemporalSurfaceAdapter
