/-
  ...
  here and in the rest of the surface; `diagnosis_exhaustive` additionally uses
  `Classical.choice` + `Quot.sound`. No custom axioms. Not imported by
  `LeanProofs.lean`; compile-is-contact only.
