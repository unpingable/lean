/-
  LeanProofs.Scratch.PathVerdict.StandardObstructions -- RPP promotion
  ...
  `LeanProofs.lean` or by any promoted admissibility kernel.
...
import LeanProofs.Scratch.PathVerdict.Edges
