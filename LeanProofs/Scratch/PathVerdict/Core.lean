/-
  LeanProofs.Scratch.PathVerdict.Core  --  Path Verdict, second stratum: refusal as data
  ...
  by `LeanProofs.lean`, `LeanProofs.BoundedCalculi`, or any promoted kernel.
  The skunkworks README names `Admissibility/PathVerdict/` as the eventual
  promoted home — promotion is an operator ceremony, not this landing.
