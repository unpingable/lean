...
theorem dn_reaches_dh : Reachable .dn .dh :=
  .trans (.step rfl)           -- Δn → Δb
    (.trans (.step rfl)        -- Δb → Δc
      (.step rfl))             -- Δc → Δh

-- Δo → Δw → Δc → Δh
theorem do_reaches_dh : Reachable .do_ .dh :=
  .trans (.step rfl)           -- Δo → Δw
    (.trans (.step rfl)        -- Δw → Δc
      (.step rfl))             -- Δc → Δh

-- Δw → Δc → Δh  (authority pipeline)
theorem dw_reaches_dh : Reachable .dw .dh :=
  .trans (.step rfl)           -- Δw → Δc
    (.step rfl)                -- Δc → Δh

-- Δp → Δr → Δw → Δc → Δh  (recursion → authority → lock-in)
theorem dp_reaches_dh : Reachable .dp .dh :=
  .trans (.step rfl)           -- Δp → Δr
    (.trans (.step rfl)        -- Δr → Δw
      (.trans (.step rfl)      -- Δw → Δc
        (.step rfl)))          -- Δc → Δh
...
-- Δr → Δw → Δc → Δh
theorem dr_reaches_dh : Reachable .dr .dh :=
  .trans (.step rfl)           -- Δr → Δw
    (.trans (.step rfl)        -- Δw → Δc
      (.step rfl))             -- Δc → Δh

-- Δb → Δc → Δh
theorem db_reaches_dh : Reachable .db .dh :=
  .trans (.step rfl)           -- Δb → Δc
    (.step rfl)                -- Δc → Δh
