...
bash scripts/check-calculus-footprint.sh      # Calculus exact 22-receipt footprint (rungs 2–3)
...
Since the v14 rung-3 admission (2026-07-17, the Weathering and
BoundedPaidReachability instances into the Calculus root, after rung 2's
signature and rung 1's Domains/Located), the custody gate must pass without
exclusions over exactly 187 public Lean files: 90 stable, 96 public
evidence, and one aggregate, across eleven stable roots and 106 ownership
relations. Any drift or failure is a regression. The separate target gate
must also report role-compatible registered target ownership for all
187/187 public sources. The v13 baseline (179/82/96/1, 98 ownerships)
stays frozen in
